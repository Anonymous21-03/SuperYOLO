...
class LoadImagesAndLabels(Dataset):  # for training/testing
    def __init__(self, path, img_size=640, batch_size=16, augment=False, hyp=None, rect=False, image_weights=False,
        ...
        self.stride = stride
        if hr_input== False:
            self.img_path = '/content/drive/MyDrive/VEDAI/images/' #zjq the path for 512*512 images
        else:
            self.img_path = '/content/drive/MyDrive/VEDAI_1024/images/' #zjq the path for 1024*1024 images
